...
LLM_text = {
    "covid": [
        "The infected area shows diffuse ground-glass opacities with bronchial air signs.",
        "Multiple patchy consolidations are visible in the lungs, with blurred borders.",
        "The lesions are distributed bilaterally and symmetrically, presenting as ground-glass densities with unclear edges.",
        "Localized areas of increased lung density show large patchy consolidation, with visible aerated bronchi within.",
        "The lesions manifest as segmental or lobar consolidations with surrounding halo-like ground-glass opacities.",
        "Extensive interlobular septal thickening is observed throughout both lungs, intermingled with ground-glass opacities.",
        "The lesions appear as multiple nodular shadows that partially coalesce into larger high-density masses.",
        "Irregular high-density shadows are present in the lung fields, with blurred edges and an infiltrative growth pattern.",
        "Predominantly ground-glass opacities interspersed with small areas of consolidation, giving a mottled appearance.",
        "Lesions radiate from the hilum toward the periphery, showing a reticular texture change.",
        "Numerous linear streaks of increased density are seen in the lung parenchyma, forming a reticular distribution.",
        "The lesions exhibit a 'paving stone' pattern, consisting of ground-glass opacities and thickened interlobular septa.",
        "Lung textures are disordered, with localized mass-like high-density shadows indicating inflammatory exudation.",
        "Consolidation areas show bronchial air signs, indicating incomplete collapse of alveoli.",
        "Diffuse interstitial changes are noted in both lower lobes near the pleura, with scattered punctate high-density shadows.",
        "The lesion margins have a feather-like appearance, with gradually transitioning density to normal lung tissue.",
        "The lesions are multifocal, with uneven density and irregular shapes.",
        "Wedge-shaped high-density shadows are present, with their bases near the pleura and apices pointing toward the hilum.",
        "Extensive interstitial changes are observed in the lung fields, accompanied by scattered punctate high-density opacities.",
        "Honeycomb structures are present in the lesion areas, suggesting possible fibrotic trends.",
        "Large patchy ground-glass opacities are seen in the outer zones of both lungs, with indistinct borders.",
        "The lesions are distributed in a mosaic pattern, with alternating areas of high and low density.",
        "The lesion center has higher density, surrounded by a low-density halo.",
        "Multiple subsegmental nodules are present, accompanied by peripheral ground-glass changes.",
        "Increased lung textures are observed, with localized circular high-density shadows and blurred edges.",
        "The lesions show tree-in-bud signs, indicating involvement of fine bronchioles.",
        "Multiple cystic lesions are present, coexisting with consolidation and ground-glass opacities.",
        "Lesions follow the distribution of bronchovascular bundles, appearing as linear streaks of increased density.",
        "Irregular patchy shadows are present in the lung fields, some of which merge into large patches.",
        "Ring-shaped high-density shadows are seen in multiple areas, with central lucency.",
        "Linear streaks of increased density are present, connected to the pleura, showing traction.",
        "Ground-glass opacities are mixed with coarse linear streaks, showing a combined pattern.",
        "Diffuse lesions are present, predominantly in the upper lobes, with uniform density.",
        "The lesion margins are serrated, with irregular edges.",
        "Lung textures are disordered, with localized 'snowflake-like' high-density shadows.",
        "The lesions show lobar consolidation, with clear borders and uniform density.",
        "Multiple satellite lesions are present around the main lesion, scattered distribution.",
        "Lesions are distributed in a map-like pattern, with multiple regions of similar density and blurred boundaries.",
        "Scattered punctate high-density shadows are present in the lung fields, showing diffuse distribution.",
        "A reverse halo sign is present, with central ground-glass opacity and an outer high-density ring.",
        "Multiple nodular shadows of varying sizes are present, with clear or blurred borders.",
        "The lesions are distributed segmentally, with increased density and clear demarcation from normal lung tissue.",
        "Lung textures are coarse and disordered, with localized 'feather-like' high-density shadows.",
        "Diffuse interstitial changes are observed, with thickened alveolar walls.",
        "Irregular patchy shadows are present in the lung fields, with some areas protruding as nodules.",
        "The lesions show alveolar exudative changes, diffusely distributed with high density.",
        "Multiple small patchy high-density shadows are present, showing a jumping distribution.",
        "The lesions are distributed in multiple small lobes, with blurred borders and uneven density.",
        "Lung textures are increased and disordered, with localized 'fog-like' high-density shadows.",
        "The lesions show mixed alveolar and interstitial changes, with complex imaging features.",
#         50
"The infected area shows reticular opacities with interlobular septal thickening, suggesting interstitial involvement.",
"Lesions appear as bilateral peripheral ground-glass opacities with subpleural sparing.",
"Consolidation is patchy and wedge-shaped, oriented toward the hilum.",
"Air bronchograms are prominent within consolidated zones, indicating air-filled bronchi surrounded by fluid.",
"Lesions show a ‘crazy-paving’ pattern — ground-glass opacities with superimposed septal thickening.",
"Infiltrates are asymmetrically distributed, favoring the lower lobes.",
"Peribronchial cuffing is visible, with thickened bronchial walls surrounding central airways.",
"Focal consolidation with surrounding halo of ground-glass opacity suggests early necrotizing pneumonia.",
"Multiple small nodules coalesce into larger confluent areas, forming ‘mass-like’ infiltrates.",
"Lung parenchyma appears hazy with reduced vascular markings, indicating alveolar filling.",
"Lesions demonstrate centrifugal spread from hilar regions to lung periphery.",
"Pleural-based opacities are present, with blunting of costophrenic angles suggesting pleural effusion.",
"Dense consolidation occupies entire segments, mimicking lobar pneumonia.",
"Ground-glass opacities are more pronounced in dependent lung zones, consistent with gravity-dependent edema or infection.",
"Lesion borders are indistinct and feathered, blending into adjacent aerated lung.",
"Bilateral symmetric involvement is noted, typical of viral or atypical pneumonia.",
"Cavitary lesions are present within consolidations, suggesting necrotizing bacterial infection.",
"Subsegmental areas of hyperlucency surround dense opacities, indicating air trapping or compensatory emphysema.",
"Mosaic attenuation pattern is observed, reflecting regional differences in ventilation or perfusion.",
"Perilobular opacities form a ‘halo’ around normal-appearing lung lobules, characteristic of organizing pneumonia.",
"Bronchiectasis is seen adjacent to chronic consolidative changes, indicating post-infectious damage.",
"Lesions exhibit ‘reverse halo’ sign — central ground-glass surrounded by ring of consolidation.",
"Septal lines are prominent, especially Kerley B lines, suggesting interstitial edema or lymphatic congestion.",
"Air-space disease predominates, with no significant mediastinal lymphadenopathy.",
"Honeycombing is absent, differentiating from fibrotic lung diseases.",
"Lesions show progressive confluence over serial imaging, indicating worsening infection.",
"Peripheral ‘subpleural curvilinear lines’ suggest organizing exudate along visceral pleura.",
"Alveolar collapse is minimal; most opacities represent fluid-filled alveoli rather than atelectasis.",
"Micro-nodules are scattered throughout both lungs, with ground-glass halos — suggestive of hematogenous spread.",
"Lesions respect anatomical boundaries, confined within lobar or segmental distributions.",
"Vascular enlargement is noted near consolidated areas, possibly due to inflammatory vasodilation.",
"Diffuse micronodular pattern with centrilobular distribution suggests infectious bronchiolitis.",
"Lesions show ‘tree-in-bud’ appearance on CT, indicating endobronchial spread of infection.",
"Reticulonodular pattern is dominant, combining interstitial thickening and nodular densities.",
"No cavitation or mass effect is present, supporting non-neoplastic etiology.",
"Air-space opacities spare the apices, favoring community-acquired bacterial pneumonia.",
"Lesions have ‘fluffy’ margins, lacking the sharp demarcation of neoplasms.",
"Pulmonary edema is ruled out by absence of cardiac enlargement or upper lobe venous redistribution.",
"Lung volumes are preserved, without evidence of volume loss or scarring.",
"Lesions regress partially after antibiotic therapy, confirming infectious origin.",
"Multifocal opacities are present, with varying stages of resolution and progression.",
"Air-fluid levels are absent, excluding lung abscess or empyema.",
"Subpleural bands and linear opacities indicate organizing pneumonia or residual fibrosis.",
"Lesions show ‘ground-glass halo’ around nodules, suggesting active inflammation or hemorrhage.",
"No lymph node enlargement or pleural nodules are seen, reducing suspicion for malignancy.",
"Distribution favors posterior and basal segments, common in aspiration pneumonia.",
"High-resolution CT reveals subtle septal thickening not visible on plain radiographs.",
"Lesions appear ‘patchy and migratory,’ changing location between scans — typical of eosinophilic or hypersensitivity pneumonitis.",
"Air bronchogram persists despite clinical improvement, indicating slow resolution of alveolar filling.",
"Overall imaging features support acute infectious process: ill-defined, bilateral, air-space opacities without structural distortion.",
